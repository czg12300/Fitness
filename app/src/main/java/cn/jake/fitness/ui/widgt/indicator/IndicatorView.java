 ...
 * 
 */
public class IndicatorView extends LinearLayout implements View.OnClickListener, OnFocusChangeListener {
	...
	protected void onDraw(Canvas canvas) {
		...
		if (mTabs.size() != 0) {
			...
			xScroll = (mCurrentScroll - ((tabID) * (getWidth() + mViewPager.getPageMargin()))) / mTabs.size();
		} else {
