...
public class IndicatorViewPager extends LinearLayout implements OnPageChangeListener {
	...
	private void initView() {
		...
		addView(mIndicator);
		addView(mViewPager, new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
	}
	...
	public void setTabHeight(float tabHeight) {
		mIndicator.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, (int) tabHeight));
	}
	...
	public void setIndicator(IIndicator indicator) {
		...
		if (indicator.getLabelList().size() != indicator.getAdapter().getCount()) {
			throw new IllegalArgumentException("indicator's labelList size is not equal pageAdapter size");
